...
public class ArmorColorRainbowTask {
    ...
    public ArmorColorRainbowTask(KnockbackFFA instance) {
        ...
        Bukkit.getScheduler().runTaskTimer(instance, () -> {
            ...
            KnockbackFFA.getInstance().getCacheHandler().getPlayerEntrys().forEach((uuid, playerEntry) -> {
                ...
                if (playerEntry.getPlayerState() == PlayerState.INGAME && playerEntry.getArmorColor() == ArmorColor.RAINBOW && playerEntry.getPlayer().getInventory().getChestplate() != null) {
