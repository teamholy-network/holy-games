...
public class PlayerJoinQuitListener implements Listener {
    ...
    public void onJoin(CachedPlayerJoinEvent event) {
        ...
        Bukkit.getScheduler().runTaskLater(Lobby.getInstance(),() -> {
            ...
            new NPCBuilder("xmas","§c§lHo ho ho", UUID.fromString("28c676c2-6a1c-4c86-a12a-d5d6ccc24419"),50,10,true,false,BukkitCore.getInstance().getLocationManager().getLocation("xmas_npc")).addHolo("Here are many Christmas presents for you on the map!","§cFind all the gifts to collect your reward.").build(player);
